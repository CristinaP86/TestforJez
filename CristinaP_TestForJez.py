...
class TestForJez:
    def cristina_test(self):
        ...
        first_name = driver.find_element_by_id('field_qh4icy2')
        first_name.send_keys('Cristina')

        last_name = driver.find_element_by_id('field_ocfup12')
        last_name.send_keys('Test')

        email_address = driver.find_element_by_id('field_29yf4d2')
        email_address.send_keys('cristina@test.co.uk')
